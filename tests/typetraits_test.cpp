...
struct TestClassMember {
  int32_t x;
};
struct TestClassMemberPrivate {
  int32_t x;

private:
  int32_t y;
};
struct TestClassStaticOnly {
  static int32_t x;
};
struct TestClassCtor {
  TestClassCtor(const TestClassCtor &) {}
};
struct TestClassDefaultCtor {
  TestClassDefaultCtor(const TestClassDefaultCtor &) = default;
};
struct TestClassDefaultDtor {
  ~TestClassDefaultDtor() = default;
};
struct TestClassVirtualDtor {
  virtual ~TestClassVirtualDtor() = default;
};
struct TestClassAbstractBase {
  virtual ~TestClassAbstractBase() = 0;
};
struct TestClassPolymorphic {
  virtual int32_t x() { return 1389; }
};
struct
    TestClassDerivedA /*                                                                       */
    : TestClass {};
...
TEST_CASE("type-traits AddLvalueReferenceT", "") {
  STATIC_REQUIRE(
      bx::isSame<bx::AddLvalueReferenceType<TestClass>, TestClass &>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddLvalueReferenceType<TestClass &>, TestClass &>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddLvalueReferenceType<TestClass &&>, TestClass &>());
  ...
  STATIC_REQUIRE(
      bx::isLvalueReference<bx::AddLvalueReferenceType<TestClass>>());
  STATIC_REQUIRE(
      bx::isLvalueReference<bx::AddLvalueReferenceType<TestClass &>>());
  STATIC_REQUIRE(
      bx::isLvalueReference<bx::AddLvalueReferenceType<TestClass &&>>());
...
TEST_CASE("type-traits AddRvalueReferenceT", "") {
  STATIC_REQUIRE(
      bx::isSame<bx::AddRvalueReferenceType<TestClass>, TestClass &&>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddRvalueReferenceType<TestClass &>, TestClass &>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddRvalueReferenceType<TestClass &&>, TestClass &&>());
  ...
  STATIC_REQUIRE(
      bx::isRvalueReference<bx::AddRvalueReferenceType<TestClass>>());
  STATIC_REQUIRE(
      !bx::isRvalueReference<bx::AddRvalueReferenceType<TestClass &>>());
  STATIC_REQUIRE(
      bx::isRvalueReference<bx::AddRvalueReferenceType<TestClass &&>>());
...
TEST_CASE("type-traits RemoveReferenceT", "") {
  ...
  STATIC_REQUIRE(bx::isSame<bx::RemoveReferenceType<TestClass &>, TestClass>());
  STATIC_REQUIRE(
      bx::isSame<bx::RemoveReferenceType<TestClass &&>, TestClass>());
...
TEST_CASE("type-traits RemovePointerT", "") {
  ...
  STATIC_REQUIRE(bx::isSame<bx::RemovePointerType<TestClass *>, TestClass>());
  STATIC_REQUIRE(
      bx::isSame<bx::RemovePointerType<TestClass **>, TestClass *>());
  STATIC_REQUIRE(
      bx::isSame<bx::RemovePointerType<bx::RemovePointerType<TestClass **>>,
                 TestClass>());

  STATIC_REQUIRE(!bx::isPointer<bx::RemovePointerType<TestClass>>());
  STATIC_REQUIRE(!bx::isPointer<bx::RemovePointerType<TestClass *>>());
  STATIC_REQUIRE(bx::isPointer<bx::RemovePointerType<TestClass **>>());
  STATIC_REQUIRE(!bx::isPointer<
                 bx::RemovePointerType<bx::RemovePointerType<TestClass **>>>());
}

TEST_CASE("type-traits AddConstT", "") {
  STATIC_REQUIRE(bx::isSame<bx::AddConstType<TestClass>, const TestClass>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddConstType<const TestClass>, const TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddConstType<volatile TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddConstType<const volatile TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddConstType<const volatile TestClass *>,
                            const volatile TestClass *const>());
  STATIC_REQUIRE(bx::isSame<bx::AddConstType<TestClass *const volatile>,
                            TestClass *const volatile>());
}
...
TEST_CASE("type-traits RemoveConstT", "") {
  ...
  STATIC_REQUIRE(bx::isSame<bx::RemoveConstType<volatile TestClass>,
                            volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::RemoveConstType<const volatile TestClass>,
                            volatile TestClass>());
  STATIC_REQUIRE(!bx::isSame<bx::RemoveConstType<const volatile TestClass *>,
                             volatile TestClass *>());
  STATIC_REQUIRE(bx::isSame<bx::RemoveConstType<TestClass *const volatile>,
                            TestClass *volatile>());
}

TEST_CASE("type-traits AddVolatileT", "") {
  STATIC_REQUIRE(
      bx::isSame<bx::AddVolatileType<TestClass>, volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddVolatileType<const TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddVolatileType<volatile TestClass>,
                            volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddVolatileType<const volatile TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddVolatileType<const volatile TestClass *>,
                            const volatile TestClass *volatile>());
  STATIC_REQUIRE(bx::isSame<bx::AddVolatileType<TestClass *const volatile>,
                            TestClass *const volatile>());
}
...
TEST_CASE("type-traits RemoveVolatileT", "") {
  ...
  STATIC_REQUIRE(
      bx::isSame<bx::RemoveVolatileType<const TestClass>, const TestClass>());
  STATIC_REQUIRE(
      bx::isSame<bx::RemoveVolatileType<volatile TestClass>, TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::RemoveVolatileType<const volatile TestClass>,
                            const TestClass>());
  STATIC_REQUIRE(!bx::isSame<bx::RemoveVolatileType<const volatile TestClass *>,
                             const TestClass *>());
  STATIC_REQUIRE(bx::isSame<bx::RemoveVolatileType<TestClass *const volatile>,
                            TestClass *const>());
}

TEST_CASE("type-traits AddCvT", "") {
  STATIC_REQUIRE(
      bx::isSame<bx::AddCvType<TestClass>, const volatile TestClass>());
  STATIC_REQUIRE(
      bx::isSame<bx::AddCvType<const TestClass>, const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddCvType<volatile TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddCvType<const volatile TestClass>,
                            const volatile TestClass>());
  STATIC_REQUIRE(bx::isSame<bx::AddCvType<const volatile TestClass *>,
                            const volatile TestClass *const volatile>());
  STATIC_REQUIRE(bx::isSame<bx::AddCvType<TestClass *const volatile>,
                            TestClass *const volatile>());
}
...
TEST_CASE("type-traits RemoveCvT", "") {
  ...
  STATIC_REQUIRE(
      bx::isSame<bx::RemoveCvType<const volatile TestClass>, TestClass>());
  STATIC_REQUIRE(
      !bx::isSame<bx::RemoveCvType<const volatile TestClass *>, TestClass *>());
  STATIC_REQUIRE(
      bx::isSame<bx::RemoveCvType<TestClass *const volatile>, TestClass *>());
}
