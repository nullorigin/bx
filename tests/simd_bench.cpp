...
void simd_rsqrt_bench(bx::simd128_t *_dst, bx::simd128_t *_src,
...
void simd_bench_pass(bx::simd128_t *_dst, bx::simd128_t *_src,
                     uint32_t _numVertices) {
...
void simd_bench() {
  ...
  uint8_t *data = (uint8_t *)bx::alloc(
      &allocator, 2 * numVertices * sizeof(bx::simd128_t), 16);
