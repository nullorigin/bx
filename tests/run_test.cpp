...
bool testAssertHandler(const bx::Location &_location, const char *_format,
                       va_list _argList) {
...
int runAllTests(int _argc, const char *_argv[]) {
  ...
  DBG("Compiler: " BX_COMPILER_NAME ", CPU: " BX_CPU_NAME
      ", Architecture: " BX_ARCH_NAME ", OS: " BX_PLATFORM_NAME
      ", CRT: " BX_CRT_NAME ", Date: " __DATE__ ", Time: " __TIME__
      ", C++: " BX_CPP_NAME);
  ...
  config.defaultColourMode =
      BX_PLATFORM_EMSCRIPTEN ? ColourMode::None : ColourMode::PlatformDefault;
