...
BX_STATIC_ASSERT(false || BX_CRT_BIONIC || BX_CRT_GLIBC || BX_CRT_LIBCXX ||
                 BX_CRT_MINGW || BX_CRT_MSVC || BX_CRT_NEWLIB);
...
BX_NO_INLINE void unusedFunction() { CHECK(false); }

void testAssert() { BX_ASSERT(false, "Assert works!"); }
