...
#include "../simd_t.hpp"
namespace bx {
template <typename Ty> BX_SIMD_INLINE Ty simd_shuf_xAzC_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_shuf_yBwD_ni(Ty _a, Ty _b) {
  const Ty xAyB = simd_shuf_xAyB(_a, _b);
  const Ty zCwD = simd_shuf_zCwD(_a, _b);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_madd_ni(Ty _a, Ty _b, Ty _c) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_nmsub_ni(Ty _a, Ty _b, Ty _c) {
  const Ty mul = simd_mul(_a, _b);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_div_nr_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_rcp_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_orx_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_orc_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_neg_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_selb_ni(Ty _mask, Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_sels_ni(Ty _test, Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_not_ni(Ty _a) {
  const Ty mffff = simd_isplat<Ty>(UINT32_MAX);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_cmpneq_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_min_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_max_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_abs_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_imin_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_imax_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_lerp_ni(Ty _a, Ty _b, Ty _s) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_sqrt_nr_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_sqrt_nr1_ni(Ty _a) {
  const Ty half = simd_splat<Ty>(0.5f);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_rsqrt_ni(Ty _a) {
  const Ty one = simd_splat<Ty>(1.0f);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_rsqrt_nr_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_rsqrt_carmack_ni(Ty _a) {
  const Ty half = simd_splat<Ty>(0.5f);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_poly1(Ty _a, float _b, float _c) {
...
template <typename Ty>
BX_SIMD_INLINE Ty simd_poly4(Ty _a, float _b, float _c, float _d, float _e,
                             float _f) {
  const Ty bbbb = simd_splat<Ty>(_b);
...
template <typename Ty>
BX_SIMD_INLINE Ty simd_poly5(Ty _a, float _b, float _c, float _d, float _e,
                             float _f, float _g) {
  const Ty bbbb = simd_splat<Ty>(_b);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_logpoly(Ty _a) {
#if 1
  const Ty result =
      simd_poly5(_a, 3.11578814719469302614f, -3.32419399085241980044f,
                 2.59883907202499966007f, -1.23152682416275988241f,
                 0.318212422185251071475f, -0.0344359067839062357313f);
#elif 0
  const Ty result =
      simd_poly4(_a, 2.8882704548164776201f, -2.52074962577807006663f,
                 1.48116647521213171641f, -0.465725644288844778798f,
                 0.0596515482674574969533f);
#elif 0
  const Ty result =
      simd_poly3(_a, 2.61761038894603480148f, -1.75647175389045657003f,
                 0.688243882994381274313f, -0.107254423828329604454f);
#else
  const Ty result =
      simd_poly2(_a, 2.28330284476918490682f, -1.04913055217340124191f,
...
template <typename Ty> BX_SIMD_INLINE Ty simd_exppoly(Ty _a) {
#if 1
  const Ty result = simd_poly5(_a, 9.9999994e-1f, 6.9315308e-1f, 2.4015361e-1f,
                               5.5826318e-2f, 8.9893397e-3f, 1.8775767e-3f);
#elif 0
  const Ty result = simd_poly4(_a, 1.0000026f, 6.9300383e-1f, 2.4144275e-1f,
                               5.2011464e-2f, 1.3534167e-2f);
#elif 0
  const Ty result = simd_poly3(_a, 9.9992520e-1f, 6.9583356e-1f, 2.2606716e-1f,
                               7.8024521e-2f);
#else
  const Ty result = simd_poly2(_a, 1.0017247f, 6.5763628e-1f, 3.3718944e-1f);
#endif // 0
...
template <typename Ty> BX_SIMD_INLINE Ty simd_log2_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_exp2_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_pow_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_dot3_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_cross3_ni(Ty _a, Ty _b) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_normalize3_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_dot_ni(Ty _a, Ty _b) {
  const Ty xyzw = simd_mul(_a, _b);
...
template <typename Ty> BX_SIMD_INLINE Ty simd_ceil_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE Ty simd_floor_ni(Ty _a) {
  const Ty tmp0 = simd_ftoi(_a);
  const Ty tmp1 = simd_itof(tmp0);
...
template <typename Ty> BX_SIMD_FORCE_INLINE Ty simd_round_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE bool simd_test_any_ni(Ty _a) {
...
template <typename Ty> BX_SIMD_INLINE bool simd_test_all_ni(Ty _a) {
